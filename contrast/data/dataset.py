...
class DatasetFolder(data.Dataset):
    ...
    def __init__(
        ...
        instance_loss_weight=0.0,
        instance_loss_func="Cosine",
        dense_branch_class_aware=False,
        ...
        self.dense_branch_class_aware = dense_branch_class_aware
...
class ImageFolder(DatasetFolder):
    ...
    def __init__(
        ...
        super(ImageFolder, self).__init__(
            ...
            instance_loss_func=instance_loss_func,
            crop=crop,
            dense_branch_class_aware=dense_branch_class_aware,
    ...
    def __getitem__(self, index):
        ...
        if self.aug_type in ["BYOL", "MVTec_AUG", "DistAug"]:
            ...
            if self.instance_loss_weight > 0.0:
                ...
                raise Exception(
                    "the augmentation type is not compatible with dense pretraining"
                )
