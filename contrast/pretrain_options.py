...
def parse_option():
    ...
    parser.add_argument(
        "--model", type=str, required=True, default="PixPro", help="architecture choice"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="PixPro",
        choices=["PixPro", "PixPro_DenseCL"],
        help="loss function for dense branch",
    )
    parser.add_argument(
        "--dense_branch_class_aware",
        action="store_true",
        help="negative pairs have to be from images of different classes",
    )
